...
2. Navigate to the **Configure the installation** ▶️ **Access the parameters** of your TaHoma box in the application.
3. Activate **Developer Mode** by tapping 👇 7 times on the PIN of your gateway (like 2001-1234-5678).
